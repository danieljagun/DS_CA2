...
@Entity
@Table(name = "predictedEmissions")
public class PredictedEmissionEntity {
    ...
    public PredictedEmissionEntity() {
    }


    public PredictedEmissionEntity(Long emissionID, String category, int year, String scenario, String gasUnits, String value) {
